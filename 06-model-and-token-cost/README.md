# Module 06 — Model Selection & Cost
...
- **More expensive** — roughly 5-10x the cost of Sonnet
...
| Writing a methods section | Opus | $0.30–1.00 |

These are rough estimates — actual costs depend on how much data Claude reads and how many iterations you do.
...
## Checking your spend: `/cost`

Want to know how much a session has cost so far? Use `/cost`:

```
/cost
```

This shows token usage and estimated cost for the current session. Helpful for building intuition about what's cheap and what's expensive — especially early on when you're calibrating.
...
**Sonnet handles 90% of scientific computing tasks. Opus is for when you need a second opinion on something genuinely complex.** The cost difference is real — be intentional about when you upgrade.
